        ...
        <Table>
          ...
          <Tbody>
            {isLoading
              ...
              : salons.map(salon => (
                <Tr key={salon.id} onClick={() => router.push(`/dashboard/salons/${salon.id}`)}>
                  <Td>
                    <div>
                  ...
                  <Td>
                    <div className="flex items-center gap-1" onClick={e => e.stopPropagation()}>
                      ...
                      {!salon.isVerified && salon.isActive && (
                        <button
                          onClick={() => setConfirm({ id: salon.id, action: 'verify', name: salon.name })}
                      ...
                      {salon.isActive ? (
                        <button
                          onClick={() => setConfirm({ id: salon.id, action: 'suspend', name: salon.name })}
                        ...
                        <button
                          onClick={() => setConfirm({ id: salon.id, action: 'unsuspend', name: salon.name })}
